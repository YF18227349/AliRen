...
//         });
        ...
        $(function () {
            ...
            // 澶撮儴menu鏄剧ず
            $(".head .menu_btn").hover(function () {
                $(".head .pull_select").slideDown();
            }).mouseleave(function () {
                $(".head .pull_select").slideUp();
            });
        
            third_slider(); // 绗�3灞忥紝杞挱
        
            eighth_slide(); // 绗� 8 灞忚疆鎾�
        ...
        function top_title_animate(dom) {
            ...
            el.children('h2').toggleClass('animated fadeInDown').css({
                "animationDelay": ".6s"
            });
            el.children('.zh_text').toggleClass('animated fadeInDown').css({
                "animationDelay": ".8s"
            });
            el.children('.en_text').toggleClass('animated fadeInDown').css({
                "animationDelay": "1s"
            });
        }
